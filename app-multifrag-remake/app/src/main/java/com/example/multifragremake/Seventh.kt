 ...
 * Use the [Seventh.newInstance] factory method to
 * create an instance of this fragment.
 */
class Seventh : Fragment() {
    val args : SeventhArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        tv.setText("Aku dengar ${args.school} itu sekolah yang solid! Kamu suka mata pelajaran apa ${args.name}?")

        btnBackward.setOnClickListener {
            val action = SeventhDirections.actionSeventhToSixth(
                args.name,
                args.hobby,
                args.asal,
                args.favorite,
        ...
        btnForward.setOnClickListener {
            ...
            val action = SeventhDirections.actionSeventhToEighth(
                args.name,
                args.hobby,
                args.asal,
                args.favorite,
    ...
    companion object {
         ...
         * @return A new instance of fragment Seventh.
         */
