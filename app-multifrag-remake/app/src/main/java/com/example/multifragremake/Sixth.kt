 ...
 * Use the [Sixth.newInstance] factory method to
 * create an instance of this fragment.
 */
class Sixth : Fragment() {
    val args : SixthArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        tv.setText("Oooh, apakah ${args.name} dan ${args.bestFriend} berteman juga di ${args.asal}? Keren. Kamu sekarang lagi sekolah dimana?")

        btnBackward.setOnClickListener {
            val action = SixthDirections.actionSixthToFifth2(args.name, args.asal, args.asal, args.favorite)
        }

        btnForward.setOnClickListener {
            val str = textField.getText().toString()
            val action = SixthDirections.actionSixthToSeventh(
                args.name,
                args.hobby,
                args.asal,
                args.favorite,
    ...
    companion object {
         ...
         * @return A new instance of fragment Sixth.
         */
