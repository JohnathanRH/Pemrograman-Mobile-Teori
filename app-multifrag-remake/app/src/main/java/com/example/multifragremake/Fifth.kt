 ...
 * Use the [Fifth.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fifth : Fragment() {
    val args : FifthArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        tv.setText("${args.name} suka makan ${args.favorite}, enak tuh! Kamu punya sahabat?")

        btnBackward.setOnClickListener {
            val action = FifthDirections.actionFifth2ToFourth(args.name, args.asal, args.asal)
        }

        btnForward.setOnClickListener {
            val str = textField.getText().toString()
            val action = FifthDirections.actionFifth2ToSixth(
                args.name,
                args.hobby,
                args.asal,
                args.favorite,
    ...
    companion object {
         ...
         * @return A new instance of fragment Fifth.
         */
